...
namespace Playground.Client.Generated
{
    ...
    public static partial class MyAPIExtensions
    {
            ...
            /// <param name='key1'>
            /// </param>
            public static Company ApiCompaniesByKeyPatch(this IMyAPI operations, int key, string key1)
            {
                return operations.ApiCompaniesByKeyPatchAsync(key, key1).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<Company> ApiCompaniesByKeyPatchAsync(this IMyAPI operations, int key, string key1, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ApiCompaniesByKeyPatchWithHttpMessagesAsync(key, key1, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// <param name='key1'>
            /// </param>
            public static Site ApiSitesByKeyPatch(this IMyAPI operations, int key, string key1)
            {
                return operations.ApiSitesByKeyPatchAsync(key, key1).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<Site> ApiSitesByKeyPatchAsync(this IMyAPI operations, int key, string key1, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ApiSitesByKeyPatchWithHttpMessagesAsync(key, key1, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
